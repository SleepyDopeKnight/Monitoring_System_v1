...
2. [Chapter II](#chapter-ii) \
    2.1. [Part 1. First effort](#part-1-first-effort)  
    2.2. [Part 2. System research](#part-2-system-research)  
    2.3. [Part 3. Visual output design for the system research script](#part-3-visual-output-design-for-the-system-research-script)   
    2.4. [Part 4. Configuring visual output design for the system research script.](#part-4-configuring-visual-output-design-for-the-system-research-script)  
    2.5. [Part 5. File system research](#part-5-file-system-research)    
